...
class SMSPowerSupplyDriver(CommandDriver):
    ...
    def startup(self):
        self.execute_command(self.GetTeslaPerAmp.command())
        self.execute_command(self.GetMid.command(['T']))
...
if __name__ == '__main__':
    ...
    driver = SMSPowerSupplyDriver(SMS_config['port'], {'library': '',
